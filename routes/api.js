...
try {
var kuhong = db.get('Ramdani'); // jan diubah
} catch (e) {
...
var creator = 'Ramdani Official' // ubah jadi nama lu
const listkey = ["Ramdaniofficial","Ramdani","Danz","Danzz"]; // ubah apikey nya, tambah aja klo mau
